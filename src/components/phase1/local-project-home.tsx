...
export default function LocalPhase1ProjectHome({
...
function LocalProjectCommandDesk({
  activeProject,
  ...
  onOpenProject: (
    project: Phase1ProjectRecord,
    step?: Phase1ProjectRecord["currentStep"],
  ) => void;
        ...
        <section className="phase-priority-strip">
          <div className="phase-priority-copy">
            ...
            <p className="phase-section-body">
              ...
              {getReadableProjectStatus(activeProject).label} · Next stage{" "}
              <strong>
...
function getReadableProjectStatus(project: Phase1ProjectRecord) {
  if (
    project.activeFlow === "master-data" &&
    project.snapshot.phase2ObjectCount > 0
  ) {
    return {
      className:
