...
| Server generation     | `src/lib/requirements/server/`   | Config, MCP client, Bedrock/Anthropic clients, real provider |
...
- MCP document lookup
- Bedrock or Anthropic model calls
- generation availability checks
- environment variable validation
- Supabase config checks for future server repositories

Never move AWS, Bedrock, Anthropic, MCP, MES, Supabase service-role, or partner
secrets into client components.
